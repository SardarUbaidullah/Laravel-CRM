                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <form action="{{ route('manager.tasks.store') }}" method="POST" id="taskForm">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            <a href="{{ route('manager.tasks.index', ['project_id' => request('project_id')]) ?: route('manager.tasks.index') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    projectSelect.addEventListener('change', function() {
        ...
        if (projectId && isManagerProject) {
            ...
            // Fetch milestones for selected project (only for manager's projects)
