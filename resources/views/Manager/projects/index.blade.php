...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Manage projects assigned to you as manager</p>
        </div>
        <!-- Removed Create Project button as manager cannot create new projects -->
    </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $projects->where('status', 'in_progress')->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $teamMembersCount ?? 0 }}</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        @foreach($projects as $project)
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500 truncate max-w-xs">{{ $project->description ?: 'No description' }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    <div class="flex items-center">
                                        <span class="font-medium text-gray-900">{{ $completedTasks }}/{{ $totalProjectTasks }}</span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    @if($project->due_date)
                                        ...
                                        @elseif(\Carbon\Carbon::parse($project->due_date)->isToday())
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('manager.projects.show', $project->id) }}" class="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 px-3 py-2 rounded-md transition duration-200 flex items-center text-xs">
                                        ...
                                        <a href="{{ route('manager.tasks.index', ['project_id' => $project->id]) }}" class="text-green-600 hover:text-green-900 bg-green-50 hover:bg-green-100 px-3 py-2 rounded-md transition duration-200 flex items-center text-xs">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                            </svg>
                                            Tasks
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-lg font-medium text-gray-900 mb-2">No projects assigned to you</p>
                <p class="text-gray-600 mb-6">You haven't been assigned any projects as manager yet.</p>
            </div>
        @endif
    </div>
</div>
