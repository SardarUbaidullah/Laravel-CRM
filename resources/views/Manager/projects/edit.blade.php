...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('manager.projects.update', $project->id) }}" method="POST" class="space-y-6" id="projectForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label for="due_date" class="block text-sm font-medium text-gray-700 mb-2">
                            Due Date *
                            <span class="text-xs text-gray-500 font-normal">(Must be after start date)</span>
                        </label>
                        <input
                            type="date"
...
function validateDates() {
    ...
    if (!dueDateInput.value) {
        ...
        dueDateValidation.innerHTML = '<span class="text-red-600">Due date is required</span>';
