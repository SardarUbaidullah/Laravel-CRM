        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-all duration-200">
                        ...
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <div class="flex space-x-1">
                                <a href="{{ route('tasks.edit', $task->id) }}" class="text-gray-400 hover:text-blue-600 p-1 rounded hover:bg-blue-50 transition-colors">
                        ...
                        <!-- Task Description -->
                        @if($task->description)
                        <p class="text-gray-600 text-xs mb-4 line-clamp-2">{{ $task->description }}</p>
                        @endif
                        ...
                        <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="flex items-center">
                                    <div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs font-medium mr-1">
                        ...
                        <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                            <a href="{{ route('tasks.show', $task->id) }}" class="text-blue-600 hover:text-blue-800 text-xs font-medium flex items-center">
                            ...
                            <form action="{{ route('tasks.destroy', $task->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="return confirm('Are you sure you want to delete this task?')" class="text-red-600 hover:text-red-800 text-xs font-medium flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gray-50 rounded-2xl p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-blue-200 p-5 hover:shadow-md transition-all duration-200">
                        <!-- Task Header -->
                        <div class="flex items-start justify-between mb-3">
                            <h4 class="font-semibold text-gray-900 text-sm leading-tight">{{ $task->title }}</h4>
                            <div class="flex space-x-1">
            ...
            <div class="bg-gray-50 rounded-2xl p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-green-200 p-5 hover:shadow-md transition-all duration-200">
                        <!-- Task Header -->
                        <div class="flex items-start justify-between mb-3">
                            <h4 class="font-semibold text-gray-900 text-sm leading-tight line-through">{{ $task->title }}</h4>
                            <div class="flex space-x-1">
                                <a href="{{ route('tasks.edit', $task->id) }}" class="text-gray-400 hover:text-blue-600 p-1 rounded hover:bg-blue-50 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        ...
                        <!-- Task Description -->
                        @if($task->description)
                        <p class="text-gray-600 text-xs mb-4 line-clamp-2 line-through">{{ $task->description }}</p>
                        @endif
