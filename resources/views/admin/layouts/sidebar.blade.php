            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('dashboard') }}"
                   class="flex items-center space-x-4 px-4 py-3.5 rounded-xl text-sm font-semibold transition-all duration-300 group relative overflow-hidden text-sidebar-foreground hover:bg-sidebar-accent/80 hover:text-sidebar-foreground">
                    ...
                    <!-- Icon -->
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 bg-sidebar-accent text-muted-foreground group-hover:text-sidebar-foreground group-hover:bg-primary/10">
                    ...
                    <div x-show="openDropdown === 'tasks'"
                        ...
                        <a href="{{ url('/tasks/create') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-green-100 text-green-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-green-500 group-hover/item:text-white">
                        ...
                        <a href="{{ url('/tasks') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-blue-500 group-hover/item:text-white">
                ...
                <div class="group">
                    ...
                    <div x-show="openDropdown === 'users'"
                        ...
                        <a href="{{ url('/users') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-purple-500 group-hover/item:text-white">
                        ...
                        <a href="{{ url('/users/create') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-indigo-100 text-indigo-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-indigo-500 group-hover/item:text-white">
                ...
                <div class="group">
                    ...
                    <div x-show="openDropdown === 'projects'"
                         x-transition:enter="transition ease-out duration-300"
                         x-transition:enter-start="opacity-0 transform -translate-y-2"
                         x-transition:enter-end="opacity-100 transform translate-y-0"
                         x-transition:leave="transition ease-in duration-200"
                        ...
                        <a href="{{ url('/projects/create') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-yellow-100 text-yellow-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-yellow-500 group-hover/item:text-white">
                                <i class="fas fa-plus text-xs"></i>
                            </div>
                ...
                <div class="group">
                    ...
                    <div x-show="openDropdown === 'files'"
                        ...
                        <a href="{{ url('/files/create') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-cyan-100 text-cyan-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-cyan-500 group-hover/item:text-white">
                        ...
                        <a href="{{ url('/files') }}"
                           class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-sidebar-foreground hover:bg-white/60 transition-all duration-200 group/item">
                            <div class="w-8 h-8 bg-gray-100 text-gray-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover/item:scale-110 group-hover/item:bg-gray-500 group-hover/item:text-white">
                                <i class="fas fa-list text-xs"></i>
                            </div>
