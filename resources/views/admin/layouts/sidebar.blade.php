        ...
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ url('/chat') }}"
                    ...
                    <!-- Message count badge -->
                    <span
                        class="bg-red-500 text-white text-xs px-1.5 py-0.5 rounded-full min-w-[20px] text-center shadow-sm">3</span>
                </a>
                ...
                <div class="group">
                    <button @click="openDropdown = openDropdown === 'tasks' ? null : 'tasks'"
                        ...
                        <div class="flex items-center space-x-2">
                            <!-- Task count -->
                            <span
                                class="bg-primary/20 text-primary text-xs px-2 py-1 rounded-full font-medium shadow-sm">
                                12
                            </span>
                            <!-- Animated chevron -->
