...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('milestones.create', ['project_id' => $project->id]) }}"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <dl class="space-y-3">
                            ...
                            <div>
                                ...
                                <dd class="text-sm text-gray-900">{{ $project->client->name ?? 'Not assigned' }}</dd>
                            </div>
                        </dl>
                    </div>
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="text-center">
                                    <a href="{{ route('tasks.index', ['project_id' => $project->id, 'milestone_id' => $milestone->id]) }}"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    @php
                        $teamMembers = $project->teamMembers->count();
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    @forelse($project->teamMembers->take(5) as $member)
