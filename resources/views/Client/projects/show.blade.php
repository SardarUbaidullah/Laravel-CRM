                ...
                <div class="flex-1">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mt-1 text-lg leading-relaxed">{{ $project->description }}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="px-8 py-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center">
                    ...
                    <p class="text-lg font-semibold text-gray-900 mt-1">{{ $project->manager->name }}</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-lg font-semibold text-gray-900 mt-1">
                        {{ $project->completedTasks->count() }}/{{ $project->tasks->count() }} tasks
                    </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-lg font-semibold text-gray-900 mt-1">{{ $project->start_date->format('M d, Y') }}</p>
                </div>

                <div class="text-center">
                    <div class="w-16 h-16 {{ $project->isOverdue() ? 'bg-red-100' : 'bg-orange-100' }} rounded-2xl flex items-center justify-center mx-auto mb-3">
                        <i class="fas fa-flag {{ $project->isOverdue() ? 'text-red-600' : 'text-orange-600' }} text-xl"></i>
                    </div>
                    <p class="text-sm text-gray-500 font-medium">Due Date</p>
                    <p class="text-lg font-semibold {{ $project->isOverdue() ? 'text-red-600' : 'text-gray-900' }} mt-1">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-2xl">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">{{ $project->tasks->count() }} tasks in total</p>
                        </div>
